...
def setup_dark_ax(ax):
    ...
    for spine in ax.spines.values():
        spine.set_color("#8a93a3")
        spine.set_linewidth(0.7)
    ax.tick_params(colors="#d0d4dc", labelsize=8)
    ax.xaxis.label.set_color("#d0d4dc")
    ax.yaxis.label.set_color("#d0d4dc")
    ax.grid(color="#2b3340", alpha=0.35, linewidth=0.5)
...
def plot_surface_3d(
    ...
    ax.set_title(title, color="white", fontsize=12, fontweight="bold", pad=8)
    ax.set_xlabel("Latent 1", color="#d0d4dc", fontsize=8, labelpad=4)
    ax.set_ylabel("Latent 2", color="#d0d4dc", fontsize=8, labelpad=4)
    ax.set_zlabel("Smoothed value", color="#d0d4dc", fontsize=8, labelpad=4)

    ax.tick_params(colors="#d0d4dc", labelsize=7)
    ax.xaxis.pane.set_facecolor((0.03, 0.04, 0.06, 1))
    ax.yaxis.pane.set_facecolor((0.03, 0.04, 0.06, 1))
    ax.zaxis.pane.set_facecolor((0.03, 0.04, 0.06, 1))
...
def make_compact_figure(
    ...
    cb.ax.tick_params(colors="#d0d4dc", labelsize=8)
    cb.outline.set_edgecolor("#d0d4dc")
